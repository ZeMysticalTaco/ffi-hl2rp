...
PLUGIN.definitions ["models/props_vehicles/car005a_physics.mdl"] = {
	name = "Broken Car",
	description = "A large broken down vehicle.",
	width = 10,
	height = 10
}
...
PLUGIN.definitions["models/Items/item_item_crate.mdl"] = {
	name = "Supply Crate",
	description = "A wooden crate with supply registry on it.",
	width = 5,
	height = 5
}